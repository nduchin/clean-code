...
var incompleteTaskHolder=document.getElementById("todo-list-block");//ul of #todo-list-block
var completedTasksHolder=document.getElementById("complete-list-block");//complete-list-block
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task-item__input input";
...
var taskCompleted=function(){
  ...
  //Append the task list item to the #complete-list-block
  var listItem=this.parentNode;
...
//Mark task as incomplete.
  ...
  //Append the task list item to the #todo-list-block.
  var listItem=this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem,taskCompleted);
}
